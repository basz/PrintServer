...
class Harkema_Pdf_Document_Tafelorderbon extends Harkema_Pdf_Document_Abstract {
    ...
    public function drawHeader(Zend_Pdf_Page $page) {
        ...
        $columnLeft = 30;
        $columnWidth = 280;
        $posY = Harkema_Pdf_Document_Abstract::drawTextBox($page, 'Tafel ' . $this->data->tableNumber,
    ...
    public function drawItem($item, Zend_Pdf_Page $page) {
        ...
        $posY = Harkema_Pdf_Document_Abstract::drawTextBox($page, $item->amount,
            ...
            $columnLeft += 20;
            $columnWidth = 5;
                $posY = Harkema_Pdf_Document_Abstract::drawTextBox($page, $item->gender,
                        self::MARGIN_LEFT + $columnLeft, self::$PAGE_HEIGHT - $this->cursorPosY, self::MARGIN_LEFT + $columnLeft + $columnWidth,
                        self::TEXT_ALIGN_LEFT, self::LINE_HEIGHT);
